...
const Login = () => {
 ...
 // console.log(tlogin);
  ...
  return (
    ...
    <div className="w-full grid gap-8 md:flex  md:grid-cols-2  
    md:max-w-5xl lg:max-w-7xl
        ">

      <div  className=' flex mx-auto justify-center items-center md:block  '>
        <div className='md: shrink-0 '>
          <img src='/src/assets/class pridge.JPG'
           className='h-48 w-full md:h-full md:w-screen md:mb-3 lg:h-full lg:w-screen  '/>
        </div>
 
        <div>
        <h1 className='font-bold text-xl mx-3 md:text-3xl lg:text-4xl'>ClassBridge: Connet<br></br> and Collaborate</h1>
        <p className='mt-5 text-sm lg:mt-1'>All your Class in One Place</p>
        </div>

      </div>
      <div className=" w-full mt-3  mx-auto justify-center items-center rounded-lg
       bg-white p-10 shadow md:w-full lg:w-full ">
